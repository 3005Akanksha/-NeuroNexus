...
length_label = tk.Label(root, text="Enter length of Password",font=font1,fg='#62F6EF',bg='#000000',width=150 )
...
generate_button = tk.Button(root, text="Generate Password", command=generate_display_password, bg='#C9F4F2',fg='#000000', cursor='hand2',font=font3)
